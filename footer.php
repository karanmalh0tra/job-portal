...
<footer class="footer1">
    ...
    <div class="copyright ptb40">
      <div class="container">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
          <span>Copyright &copy; <a href="#">Rejoinher.com</a>. All Rights Reserved - Powered by <a href="http://www.10dumbs.com" target="_blank"> 10Dumbs Inc.</a></span>
        </div>
  ...
  <div class="cd-user-modal">
    ...
    <div class="cd-user-modal-container">
      ...
      <div id="cd-login">
        <!-- log in form -->
        <form name="myform" id="mypopupform" method="post" action="controller/login.php" class="cd-form">
          <p class="fieldset">
          ...
          <p class="fieldset">
            ...
            <input name="pass" class="full-width has-padding has-border" id="signin-password" type="password" placeholder="Password">
          </p>
          <p class="fieldset">
          ...
          <p class="fieldset">
            <button type="submit" value="Login" class="btn btn-blue btn-effect" ><span style="color: rgb(0,0,0);">Login</span></button>
          </p>
        </form>
      </div>
      <!-- cd-login -->
