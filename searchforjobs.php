...
$keywords = $_GET['search-keywords'];
$location = $_GET['search-location'];
$industryId = $_GET['search-industries'];
$view_searched_jobs = $companyService->viewSearchedJobs($keywords, $location, $industryId);
  ...
  <div class="container">
    ...
    <div class="col-md-8 col-sm-12 col-xs-12 job-post-main">
      ...
      <div class="job-post-wrapper mt60">
        ...
        <?php
        foreach($view_searched_jobs as $job)
        {
          ?>
